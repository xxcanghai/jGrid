...
(function (jch) {
     ...
     */
    function jEnum(enumObj) {
        if (typeof (enumObj) !== "object")
            throw Error("jEnum 'enumObj' error");
        /**
         ...
         * @returns
         */
        enumObj.get = function (enumName, errMsg) {
            if (errMsg === void 0) { errMsg = "jEnum error, '" + enumName + "' is undefined"; }
            var _this = this;
            if (_this !== enumObj)
                throw Error("jEnum error, 错误的调用方式");
            if (typeof (enumName) !== "string")
                throw Error("jEnum error, 'enumName' must be a string");
         ...
         * @returns
         */
        enumObj.tryGet = function (enumName, defaultValue) {
         ...
         * @returns
         */
        enumObj.getName = function (enumValue, errMsg) {
            if (errMsg === void 0) { errMsg = "jEnum 'getName' error, '" + enumValue + "' is undefined"; }
            var _this = this;
            if (_this !== enumObj)
                throw Error("jEnum error, 错误的调用方式");
            if (arguments.length === 0)
                throw Error("jEnum error, 'enumValue' not found");
            var enumName = null;
            for (var i in _this) {
         ...
         * @returns
         */
        enumObj.tryGetName = function (enumValue, defaultValue) {
            if (defaultValue === void 0) { defaultValue = undefined; }
            var _this = this;
            if (_this !== enumObj)
                throw Error("jEnum error, 错误的调用方式");
         ...
         * @returns
         */
        enumObj.check = function (value, errMsg) {
            if (errMsg === void 0) { errMsg = "jEnum error, checkValue error"; }
            var _this = this;
            if (_this !== enumObj)
                throw Error("jEnum error, 错误的调用方式");
...
//# sourceMappingURL=jch.jEnum.js.map